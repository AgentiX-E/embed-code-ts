...
export function setup(): void {
  ...
  const filenames = [
    'nomic-embed-code-v1.5.int8.onnx',
  ...
  console.warn(
    '\n\u26a0\ufe0f  Embed-code ONNX model not found. Model-dependent tests will be skipped.\n' +
      '    To run the full test suite:\n' +
      '      1. Export the model:      python3 scripts/export-model.py\n' +
      '      2. Or set:                 EMBED_CODE_MODEL_PATH=/path/to/model.onnx\n' +
